...
if test_triton:
    ...
    model_url = "triton+grpc://67.58.49.52:8001/particlenet_hww_inclv2_pre2_noreg/1"
    ...
    data_config = SimpleIterDataset([], 'models/particlenet_hww_inclv2_pre2_noreg/data/ak8_MD_vminclv2_pre2_noreg_manual.yaml', for_training=False).config
    ...
    model.load_state_dict(
        ...
        torch.load(f"models/particlenet_hww_inclv2_pre2_noreg/data/net_best_epoch_state.pt", map_location=torch.device("cpu")),
        strict=False,
    )
    _ = model.eval()
    ...
    jit_model  = torch.load("models/particlenet_hww_inclv2_pre2_noreg/1/model.pt")
    _ = jit_model.eval()
