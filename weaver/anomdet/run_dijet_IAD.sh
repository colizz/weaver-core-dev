...
PREFIX=Wkk_IAD.ensem20.512loadffn-64.flat.nevt${NEVT}.seed${SEED} network_name=pheno/mlp_shared; ext_opt='-o num_ensemble 20 -o ft_layer_params [(512,0.0),(64,0.0)] -o merge_after_nth_layer 0 --load-model-weights finetune_pheno.ensemble.0 --start-lr 1e-3 --num-epochs 1 --lr-scheduler none --samples-per-epoch 5000000 --samples-per-epoch-val 500000 --batch-size 10000 --train-mode-params metric:loss --use-last-model --tensorboard-custom-fn ../tensorboard_fn/JetClassII_dijet_AD_ensemble.py';
